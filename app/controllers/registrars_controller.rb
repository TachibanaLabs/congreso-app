class RegistrarsController < ApplicationController
  ...
  private
    ...
    def registrar_params
      params.require(:registrar).permit(:fullname, :titulo, :carrera, :institucion, :direccion, :ciudad, :postal, :pais, :telefono, :correo, :cartel, :delser, :adultez, :construccion, :quien, :como, :newmun, :desigualdad, :vende, :sustenta, :futuro)
    end
end
